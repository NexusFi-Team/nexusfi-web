...
export function GoogleLoginBtn() {
  ...
  return (
    <button
      ...
      className="flex h-14 w-full items-center justify-center gap-3 rounded-xl border-2 border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 px-4 font-semibold text-zinc-700 dark:text-zinc-300 transition-all duration-200 hover:border-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-700 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0"
    >
